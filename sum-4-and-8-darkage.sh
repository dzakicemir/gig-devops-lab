...
#(. dark ages) having digits only from the set {4, 8} on the second place. e.g  549, 580..940..941..981..9821492..1498
# Hint: Use a brace expansion to make the range of numbers, a loop to check each one, and a
# conditional statement including a regular expression to see whether the second digit is in {4, 8}).
